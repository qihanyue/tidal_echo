...
def plugin_payload(msg: dict) -> dict:
    ...
    for f in ("tether_front", "tether_middle", "tether_back", "tether_context", "web_reader_enabled", "web_search_enabled", "weather_context", "location_context", "inner_voice_prompt"):
...
async def trigger_proactive_bundle(test_mode: bool = False) -> bool:
    ...
    for k in ("llm_config", "personas", "time_context", "memory_context",
              ...
              "web_reader_enabled", "web_search_enabled", "weather_context", "location_context", "inner_voice_prompt"):
